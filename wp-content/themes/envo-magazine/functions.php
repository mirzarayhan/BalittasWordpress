...
function envo_magazine_theme_stylesheets() {
	...
	// Theme stylesheet.
	wp_enqueue_style( 'envo-magazine-stylesheet', get_stylesheet_uri(), array('bootstrap'), '1.3.10'  );
...
function envo_magazine_theme_js() {
	...
	wp_enqueue_script( 'envo-magazine-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.3.10', true );
}
